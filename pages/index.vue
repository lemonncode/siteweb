<template>
  <div>
    <section>
      <v-parallax src="hero1.jpg" height="520">
        <v-layout
          ...
          class="white--text"
        >
          <img src="logo4.png" alt="Auro" height="320px"/>
          <!--
          <h1 class="white--text mb-2 display-3 text-center">Auro</h1>
          -->
          <div class="subheading mb-2 mt-4 text-center" style="font-weight: bold">
            Servicios de transporte privado
          </div>
          <v-btn :to="{name: 'app'}" class="secondary mt-5" dark large>
            Reservar vehículo
          </v-btn>
        </v-layout>
      </v-parallax>
      ...
      >
        <v-flex xs12 sm4 class="my-3">
          <div class="text-center">
            <h2 class="headline">La manera más cómoda de viajar</h2>
          ...
          <v-container grid-list-xl>
            <v-layout row wrap text-center>
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="primary--text text--lighten-2">stars</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">EXCELENTE</div>
                  </v-card-title>
              ...
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="primary--text text--lighten-2">event_available</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
              ...
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="primary--text text--lighten-2">verified_user</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">SEGURO</div>
                  </v-card-title>
                  <v-card-text style="min-height: 150px">
    ...
    <section>
      <v-parallax src="hero2.jpg" height="480">
        <v-layout column align-center justify-center>
          <div class="headline white--text mb-3 text-center">Viajar nunca ha sido tan sencillo</div>
          <v-btn
    ...
    <section>
      <v-layout
        ...
        wrap
        align-center
        class="primary white--text lighten-1"
      >
            ...
            <v-layout row wrap align-center>
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">business</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">Empresas</div>
                  </v-card-title>
              ...
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">flight_land</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
              ...
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">swap_horiz</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">Transfer</div>
                  </v-card-title>
                  <v-card-text style="min-height: 100px; color: white;">
              ...
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">pool</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">Eventos Deportivos</div>
                  </v-card-title>
                  <v-card-text style="min-height: 100px; color: white;">
              ...
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">cake</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">Celebraciones</div>
                  </v-card-title>
                  <v-card-text style="min-height: 100px; color: white;">
              ...
              <v-flex xs12 md4 offset-sm1>
                <v-card class="elevation-0 transparent white--text">
                  <v-card-text class="text-center">
                    <v-icon x-large class="white--text">airport_shuttle</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center">Excursiones</div>
                  </v-card-title>
                  <v-card-text style="min-height: 100px; color: white;">
    ...
    <section>
      <v-container grid-list-xl>
        <v-layout row wrap class="my-3">
          <v-flex xs12>
            <div class="text-center">
              <h2 class="headline">Dónde nos puedes encontrar</h2>
              <span class="subheading">
                Prestamos servicio en las principales ciudades de España
              </span>
            </div>
          </v-flex>
    ...
    <section>
      <v-parallax src="hero3.jpg" height="480">
        <v-layout column align-center justify-center>
          <div class="headline white--text mb-3 text-center">Reserva tu vehículo a través de nuestra Aplicación Web</div>
          <v-btn
            class="secondary mt-5"
            dark
            large
        ...
        <v-layout row wrap justify-center class="my-5">
          <v-flex xs12 sm4>
            <v-card class="elevation-0 transparent">
              ...
              <v-card-text>
                Puedes contactar con nosotros las 24 horas
              </v-card-text>
              <v-list class="transparent">
                ...
                <v-list-item>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>C/ Dehesa Vieja Nº55, Madrid, España</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-action>
