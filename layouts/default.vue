<template>
  <v-app>
    ...
    <v-app-bar app>
      ...
      <template v-else>
        <v-btn fab dark small color="secondary" :to="{ name: 'app' }">
    ...
    <v-footer app class="secondary" color="#ed6363" height="auto" absolute>
      <v-row justify="center" no-gutters>
        ...
        <v-btn color="white" text rounded class="my-2">
          <router-link to="politica-de-calidad"
            >Política de calidad y medio ambiente</router-link
          >
        </v-btn>
